...
A2: 2021 had the largest total. But I think it's interesting that the money dropped drastically in four years.
...
`{r}Answer <- clean_payments |> filter(str_detect(agency_name, "UNIVERSITY OF MARYLAND")) |> group_by(agency_name, vendor_name, amount, category) |> summarise(n())}`
