...
**Answer** 1. Taking UMD courses 2. grouping them 3. Spittting them out in a certain order
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** The data was arranged in descending order.
...
1.  Which class of students are taking each class.

2.  Which classes are the longest.

3.  Which classes are the fartest from the journalism building.
