...
<https://datawrapper.dwcdn.net/23p8q/1/>
...
md_gov_county<- md_gov_county |> mutate(total_vote= Cox + Moore + Lashar + Wallace + Harding + `Write-ins`) |> mutate(pct_moore = Moore/total_vote*100)
...
<https://datawrapper.dwcdn.net/TMpTg/1/>
