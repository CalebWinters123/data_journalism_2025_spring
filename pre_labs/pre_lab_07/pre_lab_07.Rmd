...
```{r echo=FALSE}
census_api_key("a60e882d80befc38772b845f82872e726a1fdd66", install=TRUE)
```
...
Is the difference between Calvert and Montgomery significant? **Answer** I don't think so. With the margin of error, there's a chance that Calvert could be more wealthy Monogamy county.

Is the difference between Howard and everyone else significant? **Answer** I would say so because Howard county continues to remain the wealthiest county in Maryland.
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** It's startling.
...
**Task** What is another question you could ask of this data? **Answer** Enrollment total for each county.
